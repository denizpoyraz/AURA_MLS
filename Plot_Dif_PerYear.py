...
#    #
    plt.savefig('/home/poyraden/AURA_MLS/Codes_debug/Plots_0407/NE_' + plotname +'.pdf')
    plt.savefig('/home/poyraden/AURA_MLS/Codes_debug/Plots_0407/NE_' + plotname +'.eps')
    #
    # plt.savefig('/home/poyraden/AURA_MLS/Codes_debug/Plots_0407/Dif_UcIntLinPerYear.pdf')
    # plt.savefig('/home/poyraden/AURA_MLS/Codes_debug/Plots_0407/Dif_UcIntLinPerYear.eps')
...
#plotmeanyearlyOpOne(Xyear,  y_mean_ucmean2,  y_std_ucint2, Ystr, 'Dif_UcMean_215-100',[0,1,2,3,4])
    ...
    plt.savefig('/home/poyraden/AURA_MLS/Plots_0407/Trend_' + Plotname +'.pdf')
    plt.savefig('/home/poyraden/AURA_MLS/Plots_0407/Trend_' + Plotname +'.eps')
   # plt.show()
...
#plotmeanyearlyOpOne(Xyear,  y_mean_ucmean2,  y_std_ucint2, Ystr, 'Dif_UcMean_215-100',[0,1,2,3,4])
    ...
    plt.savefig('/home/poyraden/AURA_MLS/Plots_0407/Reduced2_' + Plotname +'.pdf')
    plt.savefig('/home/poyraden/AURA_MLS/Plots_0407/Reduced2_' + Plotname +'.eps')
   # plt.show()
...
#df = pd.read_csv("/home/poyraden/AURA_MLS/Codes/MLS_UccleInterpolated_2004-2018_Dif.csv")
...
mean_ucmean = np.zeros((datesize,presize)); mean_ucmedian = np.zeros((datesize,presize)); mean_ucint = np.zeros((datesize,presize))
mean_ucmean2 = np.zeros((datesize,presize)); mean_ucmedian2 = np.zeros((datesize,presize)); mean_ucint2 = np.zeros((datesize,presize))

mean_rucmean = np.zeros((datesize,presize)); mean_rucmedian = np.zeros((datesize,presize)); mean_rucint = np.zeros((datesize,presize))
mean_r2ucmean = np.zeros((datesize,presize)); mean_r2ucmedian = np.zeros((datesize,presize)); mean_r2ucint = np.zeros((datesize,presize))


main_mean_ucmean = np.zeros(presize); main_mean_ucmean2 = np.zeros(presize); main_mean_rucmean = np.zeros(presize);
main_mean_r2ucmean = np.zeros(presize);
main_mean_ucint = np.zeros(presize); main_mean_ucint2 = np.zeros(presize); main_mean_rucint = np.zeros(presize);
main_mean_r2ucint = np.zeros(presize);

main_std_ucmean = np.zeros(presize); main_std_ucmean2 = np.zeros(presize); main_std_rucmean = np.zeros(presize);
main_std_r2ucmean = np.zeros(presize);
main_std_ucint = np.zeros(presize); main_std_ucint2 = np.zeros(presize); main_std_rucint = np.zeros(presize);
main_std_r2ucint = np.zeros(presize);


std_ucmean = np.zeros((datesize,presize)); std_ucmedian = np.zeros((datesize,presize)); std_ucint = np.zeros((datesize,presize))
std_ucmean2 = np.zeros((datesize,presize)); std_ucmedian2 = np.zeros((datesize,presize)); std_ucint2 = np.zeros((datesize,presize))
std_rucmean = np.zeros((datesize,presize)); std_rucmedian = np.zeros((datesize,presize)); std_rucint = np.zeros((datesize,presize))
std_r2ucmean = np.zeros((datesize,presize)); std_r2ucmedian = np.zeros((datesize,presize)); std_r2ucint = np.zeros((datesize,presize))
...
# print('test', mean_ucmean2[0][0],  mean_ucmean2[1][0],  mean_ucmean2[2][0],  mean_ucmean2[3][0],  mean_ucmean2[4][0],  mean_ucmean2[5][0])
...
plotmeanyearlyOpOne(Xyear,  y_mean_ucmean2,  y_std_ucmean2, Ystr, 'Dif_UcMean_215-100',[0,1,2,3,4],[-3,3],'Dif')
plotmeanyearlyOpOne(Xyear,  y_mean_ucmean2,  y_std_ucmean2, Ystr, 'Dif_UcMean_82-38',[5,6,7,8,9],[-2,2],'Dif')
plotmeanyearlyOpOne(Xyear,  y_mean_ucmean2,  y_std_ucmean2, Ystr, 'Dif_UcMean_31-14',[10,11,12,13,14],[-1.5,1.5],'Dif')
...
plotmeanyearlyOpOne(Xyear,  y_mean_r2ucmean,  y_std_r2ucmean, Ystr, 'RDif_UcMean_215-100',[0,1,2,3,4],[-60,60],'RDif')
plotmeanyearlyOpOne(Xyear,  y_mean_r2ucmean,  y_std_r2ucmean, Ystr, 'RDif_UcMean_82-38',[5,6,7,8,9],[-20,20],'RDif')
plotmeanyearlyOpOne(Xyear,  y_mean_r2ucmean,  y_std_r2ucmean, Ystr, 'RDif_UcMean_31-14',[10,11,12,13,14],[-10,10],'RDif')
